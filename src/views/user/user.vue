<template>
	<section>
		...
		<el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
			<el-form :inline="true">
				<el-form-item>
					<el-input v-model="datas" placeholder="用户姓名"></el-input>
				</el-form-item>
				<el-form-item>
		...
		<el-table :data="users" highlight-current-row v-loading="listLoading" @selection-change="selsChange" align="left"
		 style="width: 100%;">
			...
			<el-table-column prop="userName" label="登陆名" width="100"></el-table-column>
			...
			<el-table-column prop="param1" label="角色" width="180"></el-table-column>
			<el-table-column prop=" " label="机构" width="400">中国银行业监督管理委员会贵州监管局黔南分局</el-table-column>
			<el-table-column prop="param2" label="部门" width="100"></el-table-column>
		...
		<el-dialog title="新增" :visible.sync="addFormVisible" :close-on-click-modal="false">
			<el-form :model="addForm" label-width="80px" :rules="addFormRules" ref="addForm">
				...
				<el-form-item label="部门" align="left" prop="userDepId">
					<el-cascader v-model="addForm.userDepId" :value="addForm.userDepId" :options="options" :props="{checkStrictly:true}"
					 :show-all-levels="false" placeholder="请选择部门"></el-cascader>
				</el-form-item>
				<el-form-item label="角色" prop="userRoleId">
		...
		methods: {
			...
			handleAdd: function() {
				...
				getDepartmentList().then((res) => {
					let batchdata = [];
					batchdata = Array.from(res.data.data);
				...
				getDepartmentList().then((res) => {
					...
					/* var str = [{
						...
						"children": [{
							"value": 3,
							"children": [{
								"value": user.userDepId,
							}],
							}]
						}];
						console.log('str==='+str);
						this.editForm.userDepId = str;
						console.log('111==='+this.editForm.userDepId); */
					...
					_this.$confirm(error.data.data.message, '提示', {
						confirmButtonText: '确定',
					});
